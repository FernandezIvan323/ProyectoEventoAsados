    ...
    <div className="relative flex min-h-svh items-center justify-center bg-[#0A1428] p-4 overflow-hidden">
      ...
      <div className="relative w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold" style={{ background: 'linear-gradient(135deg, #FFFFFF 0%, #E8834A 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>AsamApp</h1>
          <p className="text-[#8BA0B0] text-sm mt-1">Iniciá sesión para acceder al sistema</p>
        </div>
        ...
        <div className="rounded-xl border border-[rgba(255,255,255,0.06)] bg-[#0F1B33] p-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <Input id="username" value={username} onChange={e => setUsername(e.target.value)} autoComplete="username" required className="h-10 bg-[#0A1428] border-[rgba(255,255,255,0.06)] text-[#FFFFFF] text-sm focus-visible:ring-[#E8834A] focus-visible:border-[#E8834A]" placeholder="Tu usuario" />
            </div>
            <div className="space-y-2">
              <Label htmlFor="password" className="text-[#8BA0B0] text-xs font-medium">Contraseña</Label>
              <Input id="password" type="password" value={password} onChange={e => setPassword(e.target.value)} autoComplete="current-password" required className="h-10 bg-[#0A1428] border-[rgba(255,255,255,0.06)] text-[#FFFFFF] text-sm focus-visible:ring-[#E8834A] focus-visible:border-[#E8834A]" placeholder="Tu contraseña" />
            </div>
        ...
        <p className="text-center mt-6 text-[#64748B] text-sm">
          ¿No tenés cuenta?{' '}
          <Link to="/register" className="text-[#E8834A] hover:text-[#D4733A] font-medium transition-colors">Registrate</Link>
        </p>
